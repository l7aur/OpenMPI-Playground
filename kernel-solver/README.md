...
![Execution time average](plots/seq_impl_1_thread.png)
![Execution time average](plots/par_impl_2_threa.png)
...
![Execution time average](plots/effect_of_threa.png)
...
![Execution time average](plots/speedup_threa.png)
...
![Execution time average](plots/efficiency_threa.png)
...
![Execution time average](plots/seq_impl_1_proc.png)
![Execution time average](plots/par_impl_2_proc.png)
...
![Execution time average](plots/effect_of_proc.png)
...
![Execution time average](plots/speedup_proc.png)
...
![Execution time average](plots/efficiency_proc.png)
